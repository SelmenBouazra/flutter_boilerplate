          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                CustomButton(text: S.of(context).confirm, onPressed: onConfirm, width: double.infinity,),
                SizedBox(height: 8.h),
                CustomButton(text: S.of(context).cancel, onPressed: context.maybePop, inverseColor: true,width: double.infinity,),
